...
import 'TransitionScreenTwo.dart';

class TransitionScreenOne extends StatefulWidget {
  const TransitionScreenOne({Key? key}) : super(key: key);

  @override
  _TransitionScreenOneState createState() => _TransitionScreenOneState();
}

class _TransitionScreenOneState extends State<TransitionScreenOne> {
  @override
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: SvgPicture.asset(
                        'assets/images/Transition_page_one.svg',
                        fit: BoxFit.contain,
                      ),
                    ),
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) => const TransitionScreenTwo(),
                          ),
                        );
                      },
